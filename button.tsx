...
import { spacing, SpacingProps 
} from '@material-ui/system';
import React from 'react';
import styled, { css } from 'styled-components';


const charcoalGrey = '#373f4a';
const black12 = 'rgba(0,0,0,0.12)';
const containedLightHover = 'rgba(255,255,255, 0.3)';
const dustyOrangeTwo = '#ef743c'; 
const dustyOrangeTwoHover = '#d16230';
const gray98 = '#fafafa';
const greyBackground = '#f7f7f7';
const lightGrey = '#bfbfbf';
const pinkishOrange = '#ff642e';
const turquoise = '#2db3c6';
const turquoiseHover = '#209aab';
const veryLightGrey = '#e9ebec';
...
// Remove when our React typedefs version is updated and includes React.ComponentProps
type GetComponentProps<T> = T extends React.ComponentType<infer P> | React.Component<infer P>
  ? P
  : never;


const sizeDesktop = (content: any) => css`
  @media (max-width: ${1480 - 1}px) {
    ${content};
  }
`;

export const sizeMobile = (content: any) => css`
  @media (max-width: ${480 - 1}px) {
    ${content};
  }
`;

const typeNavItem = css`
  font-size: 0.6875rem;
  letter-spacing: 2px;
  font-weight: 500;
